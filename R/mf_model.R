...
#' indicators are not forecasted. Each target period that overlaps the
#' observed sample receives the most recent complete high-frequency block at
#' the same period-relative position that the newest observation occupies
#' within its own period -- a MIDAS-with-leads alignment that stays
#' calendar-consistent when target periods hold varying numbers of
